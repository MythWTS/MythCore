...
/**
 * Represents an html element that is forced to always have a ertain set of classes amongst its own. That does not mean
 * the element's class attribute i always fixed to those classes. It is a normal container element, only, whenever the
 * class attribute is manipulated using any method possible, the set of ensured classes are cheked to exist. If
 * any of them was removed, it is added again.
 */
class ClassEnforcedContainerElement extends ContainerElement{
	protected $_classes;

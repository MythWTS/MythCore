...
use Core\Enum;
/**
 * The list of column classes used in the bootstrap grid system.
 * We choose to implement using the same naming convention as bootstrap both for clarity, consistency and brivity.
 * Clone members might be added in the future for the bootstrap-un-initiated, but for now, the names translate as follows:
 * -XS: Extra small. Used with small devices such as phones
 * -SM: Small. Used with small devices such as tablets and larger phones
 * -MD: Medium. Used with normal sized devices such as laptops and medium sized desktop screens
 * -LG: Large. Used with larger sized devices such as large desktop screens, TVs and projectors
 */

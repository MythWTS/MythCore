...
/**
 * A data structure to hold device size options for a bootstrap grid column
 * Constructor(Devices $device, $width=0, $offset=0, $push=0, $pull=0, $only=false, $hidden=false, $srOnly=false)
 */

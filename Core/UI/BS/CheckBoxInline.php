...
/**
 * Represents a bootstrap inline checkbox.
 ...
 */
class CheckBoxInline extends ClassEnforcedContainerElement{
	...
	public function __construct($id, $label='', $value='', $checked=false, $disabled=false, $class='', $title='', $style='', $indentContents=true){
		...
		//Creating element
		parent::__construct(array('checkbox-inline'), 'div', array($this->_label), '', $class, $title, $style, $indentContents);

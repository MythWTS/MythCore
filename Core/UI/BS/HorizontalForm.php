...
use Core\U;
/**
 * Represents a bootstrap horizontal form component
 * Constructor($contents='', $action='', $method='', $id='', $class='', $title='', $style='', $indentContents=true)
 */
class HorizontalForm extends ClassEnforcedContainerElement{
	/** Constructor($contents='', $action='', $method='', $id='', $class='', $title='', $style='', $indentContents=true) */
	public function __construct($contents='', $action='', $method='', $id='', $class='', $title='', $style='', $indentContents=true){
		parent::__construct(array('form-horizontal'), 'form', $contents, $id, $class, $title, $style, $indentContents);

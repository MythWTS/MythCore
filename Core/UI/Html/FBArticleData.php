...
use Core\U;
/**
 * A data structure to hold meta data about an article in Facebook open graph protool meta data format
 */
class FBArticleData extends FBMetaData{
	###########################################################################
	# Protected Fields
	###########################################################################
	...
	*/
	public function __construct(
		...
		parent::__construct($admins, $appId, FBObjectTypes::$Article, $title, $image, $sitename, $url, $description);

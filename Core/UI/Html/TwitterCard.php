...
use Core\U;
/**
 * A data structure to hold data about a twitter card
 */
class TwitterCard extends Object implements IMetaDataProvider{
	protected $_type, $_site, $_description;
	public function __construct(TwitterCardTypes $type=null, $site='', $description=''){
		$this->_type = $type;
		$this->_site = U::ES($site);
		$this->_description = U::ES($description);
	}
	
	public function Type(TwitterCardTypes $value=null){

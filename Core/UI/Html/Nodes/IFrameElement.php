...
/**
 * Represents a "iframe" html element in the documents object model
 * Constructor($src='', $id='', $class='', $title='', $style='', $indentContent=false)
 */
class IFrameElement extends GenericContainerElement{
	/** Constructor($src='', $id='', $class='', $title='', $style='', $indentContent=false) */
	public function __construct($src='', $id='', $class='', $title='', $style='', $indentContent=false){
		parent::__construct(Tags::$IFRAME, null, null, $id, $class, $title, $style, $indentContent);

...
use Core\UI\Html\AreaShapes, Core\UI\Html\LinkRelValues;
/**
 * Represents a "area" html element in the documents object model
 */
class AreaElement extends EmptyElement{
	/** Constructor(AreaShapes $shape, $coords, $href='', $alt='', array $attributes = null, $id='') */
	public function __construct(AreaShapes $shape=null, $coords='', $href='', $alt='', array $attributes = null, $id=''){
		parent::__construct(Tags::$AREA, $attributes, $id);
	...
	public function Shape(AreaShapes $value=null){
		if($value === null){return $this->_attributes['src'];}
		else{$this->_attributes['src'] = $value->__toString();}
	}
	///TODO: Support different format of input for this attribute 
	...
	public function Rel(LinkRelValues $value=null){

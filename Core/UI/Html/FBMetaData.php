 ...
 * instead as this class is generic. For example, if the page is a video, use the FBVideoData class instead.
 */
class FBMetaData extends Object implements IMetaDataProvider{
	###########################################################################
	# Protected Fields
	###########################################################################
	 ...
	 * Constructor(
	 * 			$admins='', $appId='',
	 * 			FBObjectTypes $type=null, $title='', $image='', $sitename='', $url='', $description='',
	 * 			$determiner='', $locale='')
	*/
	...
	public function Type(FBObjectTypes $value=null){

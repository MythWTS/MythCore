...
final class Html extends Object{
	...
	public static function Stylesheet($href, $id='', $type='text/css'){return new HtmlLinkElement($href, 'stylesheet', $type, $id);}
	public static function ShortcutIcon($href, $id=''){return new HtmlLinkElement($href, 'shortcut icon', '', null, $id);}
	public static function AppleTouchIcon($href, $id=''){return new HtmlLinkElement($href, 'apple-touch-icon', '', null, $id);}

	public static function AlternateLink($href, $type='text/html'){return new HtmlLinkElement($href, 'index', $type);}
	public static function IndexLink($href, $type='text/html'){return new HtmlLinkElement($href, 'index', $type);}
	public static function UpLink($href, $type='text/html'){return new HtmlLinkElement($href, 'up', $type);}
	public static function NextLink($href, $type='text/html'){return new HtmlLinkElement($href, 'next', $type);}
	public static function PrevLink($href, $type='text/html'){return new HtmlLinkElement($href, 'prev', $type);}
	public static function StartLink($href, $type='text/html'){return new HtmlLinkElement($href, 'start', $type);}
	public static function ChapterLink($href, $type='text/html'){return new HtmlLinkElement($href, 'chapter', $type);}
	public static function SectionLink($href, $type='text/html'){return new HtmlLinkElement($href, 'section', $type);}
	public static function SubsectionLink($href, $type='text/html'){return new HtmlLinkElement($href, 'subsection', $type);}
	public static function SearchLink($href, $type='text/html'){return new HtmlLinkElement($href, 'search', $type);}
	public static function ContentsLink($href, $type='text/html'){return new HtmlLinkElement($href, 'contents', $type);}
	public static function GlossaryLink($href, $type='text/html'){return new HtmlLinkElement($href, 'glossary', $type);}
	public static function HelpLink($href, $type='text/html'){return new HtmlLinkElement($href, 'help', $type);}
	public static function BookmarkLink($href, $type='text/html'){return new HtmlLinkElement($href, 'bookmark', $type);}
	public static function CopyrightLink($href, $type='text/html'){return new HtmlLinkElement($href, 'copyright', $type);}
	###########################################################################
	# Meta Elements
	###########################################################################
	...
	public static function DefaultStyleMeta($defaultStyle, $id=''){$res = new HtmlMetaElement('', $defaultStyle, $id); $res->HttpEquiv('default-style'); return $res;}
	public static function RefreshMeta($refresh, $id=''){$res = new HtmlMetaElement('', $refresh, $id);$res->HttpEquiv('refresh');return $res;}

	public static function ApplicationNameMeta($appName, $id=''){return new HtmlMetaElement('application-name', $appName, $id);}
	public static function AuthorMeta($author, $id=''){return new HtmlMetaElement('author', $author, $id);}
	public static function DescriptionMeta($desc, $id=''){return new HtmlMetaElement('description', $desc, $id);}
	public static function GeneratorMeta($generator, $id=''){return new HtmlMetaElement('generator', $generator, $id);}
	public static function KeywordsMeta($keywords, $id=''){return new HtmlMetaElement('keywords', $keywords, $id);}
	public static function ViewportMeta($viewport='width=device-width; initial-scale=1.0', $id=''){return new HtmlMetaElement('viewport', $viewport, $id);}
	public static function RobotsMeta($robots, $id=''){return new HtmlMetaElement('robots', $robots, $id);}
	public static function GoogleBotMeta($googleBot, $id=''){return new HtmlMetaElement('googlebot', $googleBot, $id);}
	public static function BingBotMeta($bingbot, $id=''){return new HtmlMetaElement('bingbot', $bingbot, $id);}
	public static function SlurpMeta($slurp, $id=''){return new HtmlMetaElement('Slurp', $slurp, $id);}
	###########################################################################
	# Other Head Elements
	###########################################################################
	...
	# List Elements
	###########################################################################
	public static function Dl($id='', $class='', $title='', $style='', $indentContent=true){return new HtmlDlElement($id, $class, $title, $style, $indentContent);}
	public static function Ol($id='', $class='', $title='', $style='', $indentContent=true){return new HtmlOlElement($id, $class, $title, $style, $indentContent);}
	public static function Ul($id='', $class='', $title='', $style='', $indentContent=true){return new HtmlUlElement($id, $class, $title, $style, $indentContent);}
	###########################################################################
	# Block Elements
	###########################################################################
	public static function Blockquote($content='', $id='', $class='', $title='', $style='', $indentContents=true){return new HtmlBlockquoteElement($content, $id, $class, $title, $style, $indentContents);}
	public static function Br($id='', $class='', $title='', $style=''){return new HtmlBrElement($id, $class, $title, $style);}
	public static function Details($content='', $id='', $class='', $title='', $style='', $indentContents=true){return new HtmlDetailsElement($content, $id, $class, $title, $style, $indentContents);}
	public static function Dialog($content='', $id='', $class='', $title='', $style='', $indentContents=true){return new HtmlDialogElement($content, $id, $class, $title, $style, $indentContents);}
	public static function Div($content='', $id='', $class='', $title='', $style='', $indentContents=true){return new HtmlDivElement($content, $id, $class, $title, $style, $indentContents);}
	public static function Figure($content='', $id='', $class='', $title='', $style='', $indentContents=true){return new HtmlFigureElement($content, $id, $class, $title, $style, $indentContents);}
	public static function Footer($content='', $id='', $class='', $title='', $style='', $indentContents=true){return new HtmlFooterElement($content, $id, $class, $title, $style, $indentContents);}
	public static function Header($content='', $id='', $class='', $title='', $style='', $indentContents=true){return new HtmlHeaderElement($content, $id, $class, $title, $style, $indentContents);}
	public static function Hr($id='', $class='', $title='', $style=''){return new HtmlHrElement($id, $class, $title, $style);}
	public static function Main($content='', $id='', $class='', $title='', $style='', $indentContents=true){return new HtmlMainElement($content, $id, $class, $title, $style, $indentContents);}
	public static function P($content='', $id='', $class='', $title='', $style='', $indentContents=true){return new HtmlPElement($content, $id, $class, $title, $style, $indentContents);}
	...
	# Sectioning Elements
	###########################################################################
	public static function Article($content='', $id='', $class='', $title='', $style='', $indentContents=true){return new HtmlArticleElement($content, $id, $class, $title, $style, $indentContents);}
	public static function Aside($content='', $id='', $class='', $title='', $style='', $indentContents=true){return new HtmlAsideElement($content, $id, $class, $title, $style, $indentContents);}
	public static function Nav($content='', $id='', $class='', $title='', $style='', $indentContents=true){return new HtmlNavElement($content, $id, $class, $title, $style, $indentContents);}
	public static function Section($content='', $id='', $class='', $title='', $style='', $indentContents=true){return new HtmlSectionElement($content, $id, $class, $title, $style, $indentContents);}
	###########################################################################
	# Form Elements
	###########################################################################
	...
	public static function Fieldset($content='', $id='', $class='', $title='', $style='', $indentContents=true){return new HtmlFieldsetElement($content, $id, $class, $title, $style, $indentContents);}
	public static function Form($action='', $method='', $id='', $class='', $title='', $style='', $indentContent=true){return new HtmlFormElement($action, $method, $id, $class, $title, $style, $indentContents);}
	...
	public static function OptGroup($content='', $id='', $class='', $title='', $style='', $indentContents=true){return new HtmlOptGroupElement($content, $id, $class, $title, $style, $indentContents);}

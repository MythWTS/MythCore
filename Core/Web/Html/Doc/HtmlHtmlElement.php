...
class HtmlHtmlElement extends HtmlGenericContainerElement{
	...
	/** Constructor() */
	public function __construct(HtmlHeadElement $headElement=null, HtmlBodyElement $bodyElement=null){
		...
		parent::__construct(Html5Tags::$HTML, null, array($this->_head, $this->_body));
	}

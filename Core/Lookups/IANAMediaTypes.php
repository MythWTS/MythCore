...
use Core\Enum;
/**
 * An enumeration with all the IANA registered media types (mime)
 */
final class IANAMediaTypes extends Enum{
	...
	/** Constructor($name, $value) - Protected constructor used by Initialize() to instantiate IANAMediaTypes objects */

...
use Core\Enum;
/**
 * ISO 03166-1 Alpha 2 Country Codes enumeration
 */
final class CountryCodesISO3166_1_Alpha2 extends Enum{
	public static
		...
		$Zambia,$Zimbabwe;
	/** Constructor($name, $value) - Protected constructor used by Initialize() to instantiate CountryCodesISO3166_1_Alpha2 objects */
